        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Delivering delicious food to your doorstep. Order from your favorite restaurants and enjoy fresh meals at home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#help" className="hover:text-orange-500 transition-colors">
                  Help Center
                </a>
              </li>
              <li>
                <a href="#track" className="hover:text-orange-500 transition-colors">
                  Track Order
                </a>
              </li>
              <li>
                <a href="#returns" className="hover:text-orange-500 transition-colors">
                  Returns & Refunds
                </a>
              </li>
              <li>
